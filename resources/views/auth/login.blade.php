...
<head>
  ...
  <title>{{ config('blog.name') }} | Iniciar sesión</title>
  ...
  <div class="login-box-body">
    ...
    <form class="" method="POST" action="{{ route('login') }}">
      ...
      <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }} has-feedback">
        <input type="password" class="form-control" placeholder="Contraseñas" name="password" required>
